...
class Parameters:
    def __init__(self, cla, init=True):
        ...
        self.name = "EvoRainbow_Exp_Arch_Guide_"+str(self.EA_tau)+"_elitism_"+ str(self.elitism)+ "_"+str( self.gamma)+"_"+str(self.damp) + "_"+ str(self.damp_limit)+"_Final_v1_theta_"+str(self.theta)+ "_eval_"+str(self.num_evals)+"_1.0_rs_prob_"+ str(self.prob_reset_and_sup)+"_our_M_"+str(self.OFF_TYPE)+"_" + str(self.elite_fraction) +"_"+ str(self.rl_to_ea_synch_period) +"_"+ str(self.pop_size) + "_"+str(self.EA_actor_alpha) + "_"+str(self.pr)+"_noise_"+str(self.TD3_noise)+"_Pavn_detach_"+str(self.detach_z)+"_"+str(self.actor_alpha)+ "_actorloss_MI_sa_s_"+ str(self.state_alpha) + "_random_K_"+str(cla.env) +  "_"+  str(self.tau)
